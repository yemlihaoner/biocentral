...
class BiocentralSimpleButton extends StatefulWidget {
  final void Function()? onTap;
  final IconData iconData;
  final List<String> requiredServices;

  const BiocentralSimpleButton({
    required this.onTap,
  ...
  @override
  State<BiocentralSimpleButton> createState() => _BiocentralSimpleButtonState();
}

class _BiocentralSimpleButtonState extends State<BiocentralSimpleButton> {
  @override
  void initState() {
    super.initState();
  }
