...
class TransferBOTrainingConfigCommand extends BiocentralCommand<void> {
  ...
  final ProteinRepository _proteinlRepository;
  ...
  TransferBOTrainingConfigCommand(
      ...
      required ProteinRepository repository,
      ...
      : _biocentralProjectRepository = biocentralProjectRepository,
        ...
        _proteinlRepository = repository,
        _boClient = client,
        _trainingConfiguration = trainingConfiguration;

  @override
  Stream<Either<T, void>> execute<T extends BiocentralCommandState<T>>(T state) async* {
    ...
    final fileRecord =
        await BiotrainerFileHandler.getBiotrainerInputFiles(_biocentralDatabase.getType(), entryMap, targetFeature);
    ...
    final transferEitherLabels =
        await _boClient.transferFile(databaseHash, StorageFileType.labels, () async => fileRecord.$2);
    final transferEitherMasks =
        await _boClient.transferFile(databaseHash, StorageFileType.masks, () async => fileRecord.$3);
